...
public class AutoCharacterController extends CharacterController {
    ...
    //Setter und Getter der Variabelen
    ...
    //Funktion zu automatischen bewegen der Spieler. ohne Bombe
    @Override
    public void movement() {
        //sobald eine Wand getroffen wird, wird die Richtung random weitergegeben
        ...
        updatePosition();
        //wechselt automatisch die Richtung nach 120 Millisekunden
        if (getpApplet().frameCount % 120 == 0)
            getAutoCharacter().setDirection(getDirections().getRandomDirection(getAutoCharacter().getDirection()));
    }
}
