                ...
                if (getField()[i].isEmpty()) {
                    ...
                    if (getpApplet().keyCode == getpApplet().DOWN
                        ...
                        if (getField()[i].getCornerRightUpX() >= getCharacter().getCornerRightDownX()
                            ...
                            for (int j = getCharacter().getSpeed(); j > 0; i--) {
                                if (getField()[i].getCornerRightUpX() >= getCharacter().getCornerRightDownX()
                                        && getField()[i].getCornerRightUpY() > getCharacter().getCornerRightDownY() + j
                                        && getField()[i].getCornerLeftUpX() <= getCharacter().getCornerLeftDownX()
                                        && getField()[i].getCornerLeftUpY() > getCharacter().getCornerLeftDownY() + j) {
                                    down(j);
                                    break forSchleife;
                                }
